...
interface MultiSelectProps
  ...
  handleCommandSubmit: (name: string) => Promise<string>
}

export const MultiSelectImages = React.forwardRef<
  HTMLButtonElement,
  MultiSelectProps
>(
  (
                  ...
                  {selectedValues.slice(0, maxCount).map((value) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {option?.label}
                        <XCircle
                          className="ml-2 h-4 w-4 cursor-pointer no-toggle"
                          onClick={(event) => {
...
MultiSelectImages.displayName = "MultiSelectImages";
